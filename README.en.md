...
[![Release](https://img.shields.io/badge/release-v1.6.2-blue)](RELEASE.md)

**v1.6.2** is released: Lincoln switches to a global npm plugin model. Install with `npm install -g @sushanglewis/lincoln`; projects opt in via `.lincoln.yaml`.
